...
const ShaderBackground = () => {
  ...
  const fsSource = `
    ...
    // Adapted to MG Webworks neon green (0.48, 1.0, 0.31) but slightly dimmed
    const vec4 lineColor = vec4(0.2, 0.6, 0.2, 0.8);
    ...
    void main() {
      ...
      // Adapted to MG Webworks dark background #050505 (~ 0.02)
      vec4 bgColor1 = vec4(0.02, 0.02, 0.02, 1.0);
      vec4 bgColor2 = vec4(0.02, 0.03, 0.02, 1.0);
